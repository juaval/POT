...
config=slurm_configs/POT_slurm_config1.csv
...
../../../../../../../../usr/local/spades/4.2.0/bin/spades.py --meta -t 32 --pe1-1 ${fw_paired} --pe1-2 ${rv_paired} --pe1-s ${fw_unmatched} --pe1-s ${rv_unmatched} -o ../../../02_SCAFFOLDING/${output_dir}
