...
SemiBin2 train_self --data samples/${sample_name}_contigs/data.csv --data-split samples/${sample_name}_contigs/data_split.csv --output multi_output/${sample_name}_model -t 64
